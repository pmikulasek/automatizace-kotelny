...
def read_temp(i):
 if i==1:
  device_folder = glob.glob(base_dir + '28-0000079a1444')[0]
 elif i==2:
  device_folder = glob.glob(base_dir + '28-0000079aab99')[0]
 elif i==3:
  device_folder = glob.glob(base_dir + '28-0000079b775a')[0]
 elif i==4:
